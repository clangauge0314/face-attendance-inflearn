export interface SignupRequest {
  ...
  export interface AdminAccessStatsItem {
    label: string
    count: number
  }
  
  export interface AdminAccessStats {
    daily: AdminAccessStatsItem[]
    hourly: AdminAccessStatsItem[]
    organizations: AdminAccessStatsItem[]
    userRanking: AdminAccessStatsItem[]
  }
