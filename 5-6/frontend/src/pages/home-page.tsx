...
import { AccessModal } from "../components/access/access-modal";
...
const HomePage = () => {
  ...
  const [_refreshHistory, _setRefreshHistory] = useState(0)
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto max-w-4xl">
          ...
          <AccessSection onCheckInClick={() => setIsCheckInModalOpen(true)} />
        </div>
      </div>
      <AccessModal isOpen={isCheckInModalOpen} onClose={() => setIsCheckInModalOpen(false)} />
    </div>
  );
};
