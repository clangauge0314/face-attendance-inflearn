...
import { OrganizationParticipationChart } from '../components/admin/stats/organization-participation-chart'
import { UserRankingChart } from '../components/admin/stats/user-ranking-chart'
      ...
      <div className="flex-1 overflow-y-auto p-8">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <OrganizationParticipationChart data={chartStats?.organizations || []} delay={0.5} />
            <UserRankingChart data={chartStats?.userRanking || []} delay={0.6} />
          </div>
        </div>
      </div>
    </div>
