...
export const AccessSection = ({ onCheckInClick, refreshHistoryKey }: AccessSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <AccessChart refreshHistoryKey={refreshHistoryKey} />
      </motion.div>
      ...
      >
        ...
        <AccessHistory refreshHistoryKey={refreshHistoryKey} />
      </motion.div>
    </motion.div>
  )
}
